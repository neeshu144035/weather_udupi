...
model_path =  r'C:\Users\neesh\OneDrive\Documents\medical_diagnosis\svc.pkl'
...
def get_weather(request):
    ...
    api_key = 'ede645f9c9a43728535a844619ae6806'  # Replace with your actual API key
...
def get_predicted_value(patient_symptoms):
    ...
    for symptom in patient_symptoms:
        if symptom in symptoms_dict:  # Check if the symptom exists in the dictionary
...
def disease_predictor(request):
    try:
        ...
        return Response({"disease": predicted_disease}, status=200)
